        ...
        <div className="space-y-6">
            <div className="rounded-lg border border-[#E7E7E7] bg-[#FAFAFA] p-6">
                <div className="mb-6 flex items-center justify-between">
                    ...
                    <button className="flex items-center gap-2 px-4 py-2 text-white bg-gray-800 rounded-lg hover:bg-gray-700 transition duration-300">
                ...
                <button
                    className="text-xl font-semibold text-[#2C3333] mt-10 rounded-lg px-4 py-2 hover:bg-gray-200 transition-colors"
                >
                    View All Users
                </button>
