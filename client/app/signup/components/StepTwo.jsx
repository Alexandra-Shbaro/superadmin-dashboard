...
const StepTwo = ({ onNext, setter }) => {
  ...
  // Update parent state when the form is valid
  useEffect(() => {
    if (isFormValid) {
      setter({
        companyEmail,
  ...
  }, [companyEmail, companyNumber, businessWebsite, isFormValid, setter]);
      ...
      <div className="bg-white shadow-md rounded-lg p-8 w-[500px] mx-auto mb-5">
        <div className="mb-4">
          ...
          <input
            ...
            className={`mt-2 p-2 w-full border ${
              errors.email ? "border-red-500" : "border-lightGrey"
            } rounded-md focus:outline-none focus:ring-2 focus:ring-logoOrange`}
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className={`mt-2 p-2 w-full border ${
              errors.phone ? "border-red-500" : "border-lightGrey"
            } rounded-md focus:outline-none focus:ring-2 focus:ring-logoOrange`}
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className={`mt-2 p-2 w-full border ${
              errors.website ? "border-red-500" : "border-lightGrey"
            } rounded-md focus:outline-none focus:ring-2 focus:ring-logoOrange`}
        ...
        <button
          ...
          className={`w-full py-3 ${
            isFormValid ? "bg-logoOrange" : "bg-gray-400 cursor-not-allowed"
          } text-offWhite rounded-md hover:bg-logoYellow transition-all`}
